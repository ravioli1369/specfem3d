...
!   Masaru Nagaso, Elif Oral, Daniel Peter, Elliott Sales de Andrade,  James Smith, Carl Tape, Eduardo Valero Cano,
!   Huihui Weng, Zhinan Xie.
...
!   Dimitri Komatitsch, University of Pau, Qinya Liu and others, Caltech.
...
!   Dimitri Komatitsch, University of Pau, and Qinya Liu, Caltech.
!     serial version, regular mesh, adjoint and kernel calculations, ParaView support
!
! version 1.2, July 2004:
!   Min Chen and Dimitri Komatitsch, Caltech.
!     full anisotropy, volume movie
!
! version 1.1, October 2002:
!   Dimitri Komatitsch, Caltech
!     Zhu's Moho map, scaling of Vs with depth, Hauksson's regional model, attenuation, oceans, movies
!
! version 1.0 (MPI), May 2002:
!   Dimitri Komatitsch, Caltech, USA.
!     first MPI version based on global code
!
! version 0.0, December 1996:
!   Dimitri Komatitsch, IPG Paris, France.
!     first 3-D solver for the CM-5 Connection Machine,
